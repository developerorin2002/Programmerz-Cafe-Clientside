                            ...
                            <div>
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h5 className=' custom-border-pdf'>Name : Fahim Muntasir Orin</h5>
                                    </div>
                                    <div className="col-lg-6">
                                    ...
                                    <div className="col-lg-6">
                                        <h6 className='custom-border-pdf'>Email : developerorin2002@gmail.com</h6>
                                    </div>
                                    <div className="col-lg-6">
                                        <h6 className='custom-border-pdf'>Email Status : verified</h6>
                                    </div>
